  ...
  try {
    ...
    if (parseInt(check.rows[0].count, 10) === 0) {
      ...
      await client.query(`
        ...
        (
          'sess-001', 'a0000000-0000-0000-0000-000000000001', 'Super Admin', 'superadmin@brilian.ai', 'System Administration',
        ...
        (
          'sess-002', 'a0000000-0000-0000-0000-000000000001', 'Super Admin', 'superadmin@brilian.ai', 'System Administration',
