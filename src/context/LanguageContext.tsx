...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    'profile.vision_val': 'Qwen 2.5 Vision + Ollama',
    ...
    'help.step1_desc': 'Unggah file PDF pada menu Upload Dokumen untuk ekstraksi teks presisi tinggi menggunakan AI Vision OCR (Qwen 2.5 VL).',
    ...
    'table.col_status': 'Basis AI',
    'table.col_actions': 'Aksi',
    'table.status_active': 'Aktif',
    'table.status_inactive': 'Non-Aktif',
    'table.toggle_tooltip': 'Klik untuk mengubah status basis pengetahuan AI',
    ...
    'dash.welcome_desc': 'Unggah dokumen PDF untuk dipindai oleh AI Vision (Qwen 2.5 VL), dipotong dengan teknik sliding window, dan diindeks menjadi vektor 1024-dimensi untuk temu-balik data akurat tanpa halusinasi.',
    ...
    'upload.step2_title': 'Vision OCR (Qwen 2.5)',
    ...
    'upload.step4_title': 'Dense Embedding (BGE-M3)',
  ...
  en: {
    ...
    'help.step1_desc': 'Upload PDF files in the Upload Document menu for high-precision text extraction via AI Vision OCR (Qwen 2.5 VL).',
    ...
    'table.col_status': 'AI Status',
    'table.col_actions': 'Actions',
    'table.status_active': 'Active',
    'table.status_inactive': 'Inactive',
    'table.toggle_tooltip': 'Click to toggle AI knowledge status',
    ...
    'dash.welcome_desc': 'Upload PDF documents to be scanned by AI Vision (Qwen 2.5 VL), chunked with sliding window, and indexed into 1024-dimensional vectors for accurate hallucination-free retrieval.',
